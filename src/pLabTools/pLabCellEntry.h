...
class pLabCellEntry : public QWidget, public pMolStackObject
{
    Q_OBJECT

public:
    pLabCellEntry(pMolKernelInterface* p_interface);
    static pLabCellEntry* create(pMolKernelInterface* interface, pMolCmd* cmd);
