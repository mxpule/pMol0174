...
RenderTranslatedText::RenderTranslatedText(const QString &p_s, int x, int y, int p_charWidth, int p_charSize) : RenderObject()
{ 
...
void RenderTranslatedText::Render(QPainter *painter, int x, int y)
{
