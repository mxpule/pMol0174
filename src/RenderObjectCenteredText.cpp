...
RenderObjectCenteredText::RenderObjectCenteredText(const QString &p_s, int x, int y, int p_charWidth, int p_charSize) : RenderObject()
{ 
...
void RenderObjectCenteredText::Render(QPainter *painter, int x, int y)
{
